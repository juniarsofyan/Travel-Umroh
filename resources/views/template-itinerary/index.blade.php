            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Daftar Template Itinerary</h3>
                        <div class="pull-left box-tools">
                            <a href="{{ route('template-itinerary.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i>&nbsp;&nbsp;Tambah Template Itinerary</a>
                        </div>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        ...
                        <table id="datatable-standard" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                @php $no = 1; @endphp
                                @forelse ($daftarTemplateItinerary as $row)
