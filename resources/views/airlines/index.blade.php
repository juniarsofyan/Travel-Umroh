            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">List Maskapai</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                            ...
                            <tbody>
                                ...
                                @forelse ($airlines as $row)
                                    <tr>
                                        ...
                                        <td>{{ $row->name }} </td>
                                        <td>
                                            <form action="{{ route('airlines.destroy', $row->id) }}" method="POST">
                                                @csrf
                                                <input type="hidden" name="_method" value="DELETE">
                                                <a href="{{ route('airlines.edit', $row->id) }}" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
