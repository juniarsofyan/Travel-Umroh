...
<div class="content-wrapper">
    ...
    <section class="content">
        <form method="POST" action="{{ route('itinerary-templates.store') }}">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <div>
                            ...
                            {{-- <div class="box-footer">
                                ...
                                <button wire:click="showInputBoxes" class="btn btn-primary">Tambahkan Detail</button>
                            </div> --}}
                        </div>
                    </div>
                </div>
            ...
            {{-- @if($isInputShown)
                @livewire('itinerary-events', ['jumlahHari' => $jumlahHari])
            @endif --}}
