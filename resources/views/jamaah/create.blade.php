            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Tambah Jamaah</h3>
                    </div>
                    <!-- /.box-header -->

                    <!-- form start -->
                    <form role="form" action="{{ route('jamaah.store') }}" method="POST">
                        @csrf
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="tanggal_lahir" class="form-control {{ $errors->has('tanggal_lahir') ? 'is-invalid':'' }}" id="tanggal_lahir" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="telepon" class="form-control {{ $errors->has('telepon') ? 'is-invalid':'' }}" id="telepon" required>
                            </div>
